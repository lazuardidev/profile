      ...
      <div className='container mx-auto'>
        ...
        <div className='md:hidden'>
          <div className='flex flex-col gap-6'>
            <div className='space-y-2'>
              <h2 className='text-2xl font-bold text-gray-900 dark:text-white leading-tight tracking-tight'>
                Tools I Use to Build
              </h2>
              <p className='text-gray-600 dark:text-[#A4A7AE] text-sm leading-7'>
              ...
              <div key={skill.name}>
                <div className='flex items-center gap-1 py-4'>
                  <div className='flex items-center gap-1 flex-1'>
                    ...
                    <span className='text-base font-normal text-gray-900 dark:text-white leading-8 tracking-tight'>
                      {skill.name}
                    </span>
                  </div>
                  <div className='text-base font-bold text-gray-900 dark:text-white leading-8 tracking-tight'>
                    <AnimatedCounter target={skill.percentage} suffix='%' />
                  </div>
                </div>
                <motion.div
                  className='h-1 bg-gray-200 dark:bg-[#22252B] rounded-full mb-4 overflow-hidden'
                  initial={{ opacity: 0 }}
        ...
        <div className='hidden md:flex gap-48'>
          <div className='flex-1'>
            ...
            <p className='text-gray-600 dark:text-[#A4A7AE] mb-12'>
              From code to design — here&apos;s the tech that helps me turn
              ideas into real products.
            </p>
          ...
          <div className='flex-1 space-y-0'>
            <div className='flex items-center gap-6 mb-6'>
              <div className='h-px bg-gray-200 dark:bg-[#22252B] flex-1' />
              <div className='h-1 w-48 bg-gray-900 dark:bg-white' />
            </div>
            ...
            {skills.map((skill, index) => (
              <div key={skill.name}>
                ...
                {index < skills.length - 1 && (
                  <div className='h-px bg-gray-200 dark:bg-[#22252B] my-4' />
                )}
              </div>
            ))}
          </div>
