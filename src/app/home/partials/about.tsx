    ...
    >
      <div className='container mx-auto'>
        ...
        <div className='md:hidden'>
          ...
          <div className='w-full h-px bg-gray-200 dark:bg-[#22252B] mb-6' />
            ...
            <div className='space-y-6'>
              <div className='space-y-3'>
                ...
                <div className='space-y-1'>
                  <h3 className='text-lg font-bold text-gray-900 dark:text-white leading-8'>
        ...
        <div className='hidden md:block'>
          <div className='flex justify-between items-start mb-12'>
            ...
            <div className='text-right'>
              <p className='text-gray-600 dark:text-[#A4A7AE] mb-32'>
                About Me
              </p>
              <div className='flex items-center gap-4'>
                <Link
          ...
          <div className='h-px bg-gray-200 dark:bg-[#22252B] mb-12' />
